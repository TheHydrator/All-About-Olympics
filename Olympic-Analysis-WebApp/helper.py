...
def most_successful_athletes(df, sport):
    ...
    if sport != 'Overall':
        temp_df = temp_df[temp_df['Sport'] == sport]  # filter out the specific sport
...
def most_successful_country_wise(df, country):
    ...
    temp_df = temp_df[temp_df['region'] == country] # filter out the specific sport
...
def weight_v_height(df, sport):
    ...
    if sport != 'Overall':
        temp_df = athlete_df[athlete_df['Sport'] == sport]  # filter out the specific sport
        return temp_df
    else:
        return athlete_df
